...
class MapWidget(HiddenInput):
    ...
    class Media:
        css = {
            "all": (
                "api/css/leaflet.css",
                "api/css/leaflet.compass.css",
                "api/css/leaflet-custom.css",
            )
        }
        js = (
            "api/js/lib/leaflet.js",
            "api/js/lib/leaflet.compass.js",
            "api/js/map-tools.js",
            "api/js/widgets/map.js",
        )
    ...
    def get_context(self, name, value, attrs):
        ...
        attrs.update(
            ...
            js_args={k: json.dumps(v) for k, v in self.js_args.items()},
        )
